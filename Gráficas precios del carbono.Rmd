...
UEG <- ggplot(P_c) + geom_line(aes(x = Fecha, y = UE, color = "Precio"), na.rm =T) + geom_line(aes(x = Fecha, y = (((PIB_UE/100000) - 120))*2 , color = "PIB"), na.rm = T) + scale_y_continuous(
...
CoreaG <- ggplot(P_c) + geom_line(aes(x = Fecha, y = Corea, color = "Precio"), na.rm = T) + geom_line(aes(x = Fecha, y = (PIB_Corea/100000)*2.5 - 12.5 , color = "PIB"), na.rm = T) + scale_y_continuous(
...
NZG <- ggplot(P_c) + geom_line(aes(x = Fecha, y = NuevaZelanda, color = "Precio"), na.rm = T) + geom_line(aes(x = Fecha, y = (PIB_NuevaZelanda/3750)*2 - 60, color = "PIB"), na.rm = T) + scale_y_continuous(
